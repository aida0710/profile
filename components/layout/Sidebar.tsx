...
export function Sidebar() {
    ...
    return (
        <aside
            className='fixed left-0 top-0 z-40 hidden h-screen w-60 flex-col border-r border-warm-border bg-warm-bg sm:flex'>
            {/* Profile section */}
            <div className='flex flex-col items-center px-6 pb-6 pt-8'>
                <Image isBlurred alt='Masaki Aida のプロフィール写真' className='h-20 w-20' radius='full'
                       src='/neko.jpg' />
