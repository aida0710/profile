...
export function BlogCard({post, searchQuery = ''}: BlogCardProps) {
    ...
    return (
        ...
        >
            <article
                className='flex w-full flex-col gap-4 overflow-hidden rounded-xl border border-warm-border bg-warm-surface p-5 transition-[transform,border-color,box-shadow] duration-300 hover:-translate-y-1 hover:border-warm-accent/30 hover:shadow-lg hover:shadow-warm-accent/5 md:flex-row'>
