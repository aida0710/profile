            ...
            <Card className='h-48 w-full'>
                <div className='flex h-48 flex-col gap-4 p-4 md:flex-row'>
                    <div className='w-full md:w-2/3'>
                        <div className='mb-4 h-6 w-3/4 rounded bg-default-200'></div>
                        <div className='mb-2 h-4 w-full rounded bg-default-100'></div>
                        <div className='h-4 w-5/6 rounded bg-default-100'></div>
                    </div>
                    <div className='order-first w-full md:order-last md:w-1/3'>
                        <div className='h-32 w-full rounded bg-default-200'></div>
                    </div>
                </div>
            </Card>
        </Skeleton>
