export const statusMessages: () => string[] = (): string[] => {
    return ['最近は、ネットワークインフラとネットワークセキュリティー、パケット操作などに手を出しています。'];
};
...
export const timeTableData = (): TimeLineItem[] => {
    return [
        ...
        },
        {
            ...
            description: 'PocketMine-MPを利用したマインクラフトサーバーの開発と運営を行いました。インフラからプラグインの開発、コミュニティ管理まで行い、約700人規模のコミュニティへと成長させました',
        },
    ];
};
