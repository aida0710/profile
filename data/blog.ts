...
export const blogPosts: BlogPost[] = [
    ...
    },
    {
        ...
        content: [
            '100Programs 7期からアラムナイメンターとして運営に協力させていただけることになりました。',
            'よろしくお願いいたします。',
            '',
        ...
        date: '2025年02月03日',
        images: [],
        tags: ['100Programs', 'アラムナイ', 'メンター'],
    },
    {
        slug: '100Programs-5th',
        title: '100Programs 5thに参加しました。',
        content: [
            '高校生最後の春休みに100Programs 5期に参加しました。',
